  ...
  const projects = await Promise.all([
    prisma.project.create({
      data: {
        ...
        githubToken: 'demo-token-platform-api-service',
        webhookSecret: 'demo-webhook-secret-platform-api-service',
    ...
    prisma.project.create({
      data: {
        ...
        githubToken: 'demo-token-web-dashboard-app',
        webhookSecret: 'demo-webhook-secret-web-dashboard-app',
    ...
    prisma.project.create({
      data: {
        ...
        githubToken: 'demo-token-payment-gateway-ms',
        webhookSecret: 'demo-webhook-secret-payment-gateway-ms',
    ...
    prisma.project.create({
      data: {
        ...
        githubToken: 'demo-token-mobile-bff-service',
        webhookSecret: 'demo-webhook-secret-mobile-bff-service',
        allowPRs: true, allowPush: true,
        adminUsers: 'kchul199',
        branchFilter: '*',
    ...
    prisma.project.create({
      data: {
        ...
        githubToken: 'demo-token-data-pipeline-etl',
        webhookSecret: 'demo-webhook-secret-data-pipeline-etl',
        allowPRs: true, allowPush: true,
        adminUsers: '',
        branchFilter: '*',
